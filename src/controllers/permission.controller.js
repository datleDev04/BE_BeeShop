...
export class PermissionController {
  static createNewPermission = async (req, res, next) => {
    try {
      ...
      SuccessResponse(res, StatusCodes.CREATED, 'Create New Permission successfully', Transformer.transformObjectTypeSnakeToCamel(newPermission.toObject()));
    } catch (error) {
      next(error);
    }
  };
  static getPermission = async (req, res, next) => {
    try {
      ...
      SuccessResponse(res, StatusCodes.OK, 'Get Permission successfully', Transformer.transformObjectTypeSnakeToCamel(permission.toObject()));
    } catch (error) {
      next(error);
    }
  };
  ...
  static updatePermission = async (req, res, next) => {
    try {
      ...
      SuccessResponse(res, StatusCodes.OK, 'Updated Permission successfully', Transformer.transformObjectTypeSnakeToCamel(permissions.toObject()));
    } catch (error) {
      next(error);
    }
  };
  static deletePermission = async (req, res, next) => {
    try {
      ...
      SuccessResponse(res, StatusCodes.OK, 'Delete Permission successfully', Transformer.transformObjectTypeSnakeToCamel(deletedPermission.toObject()));
    } catch (error) {
      next(error);
    }
  };
